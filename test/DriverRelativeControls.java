 ...
 */
@TeleOp(name = "DriverRelativeControl", group = "TeleOp")
public class DriverRelativeControls extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            RightFront_Motor.setPower(gamepadYControl * Math.abs(gamepadYControl) - gamepadXControl * Math.abs(gamepadXControl) + driveTurn);
            RightBack_Motor.setPower(gamepadYControl * Math.abs(gamepadYControl) + gamepadXControl * Math.abs(gamepadXControl) + driveTurn);
            LeftFront_Motor.setPower(gamepadYControl * Math.abs(gamepadYControl) + gamepadXControl * Math.abs(gamepadXControl) - driveTurn);
            LeftBack_Motor.setPower(gamepadYControl * Math.abs(gamepadYControl) - gamepadXControl * Math.abs(gamepadXControl) - driveTurn);

            /*RightFront_Motor.setPower(driveVertical - driveHorizontal + driveTurn);
            RightBack_Motor.setPower(driveVertical + driveHorizontal + driveTurn);
            LeftFront_Motor.setPower(driveVertical + driveHorizontal - driveTurn);
            LeftBack_Motor.setPower(driveVertical - driveHorizontal - driveTurn);*/
        }
        telemetry.update();
    }
